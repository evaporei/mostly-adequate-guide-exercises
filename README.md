...
Exercises of the [Mostly Adequate Guide to Functional Programming book](https://github.com/MostlyAdequate/mostly-adequate-guide).

## Overview

All exercises from the book can be completed in your editor & terminal, using `npm`.
